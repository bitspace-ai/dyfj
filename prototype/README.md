...
next run recovers a saved Vitest process group only when the recorded recovery
directory, run generation, leader start time, and command still match. If the
